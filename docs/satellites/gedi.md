...
The _vector_ parameter indicates whether you whish to download the data as vectors or rasters.
...
See the API reference of [`geefetch.data.get.download_gedi`](../api/core/get.md#geefetch.data.get.download_gedi_l2a_vector) for more details.
